...
const Presentation: React.FC = () => {
  ...
  return (
    <>
      <div className="relative mt-20 ml-5 sm:ml-5 md:ml-[19%] mr-auto flex flex-row max-w-[90%] xl:max-w-[50%]">
        ...
        <div className="flex flex-col">
          ...
          <h1
            className="text-primary-accent text-base sm:text-2xl xl:text-3xl font-medium -tracking-[0.03em] pr-0 sm:pr-8 xl:pr-0 mt-2 sm:mt-5">
            {t('presentation_text')}
          </h1>
        </div>
      </div>
      <h1 className="text-primary-text text-base sm:text-2xl xl:text-3xl font-medium -tracking-[0.03em] w-[90%] xl:w-[75%] text-justify mx-auto my-20">
